...
%   computes the shelf fluxes QVS0, QTS0, QSSS0 and shelf variables
%   SE0, TE0, PHI0 for the given parameters P, boundary conditions F
...
[Te0, Se0] = bin_zmodel_ocean_profiles(Ts, Ss, zs, H0);
...
% Compute the above-sill fluxes before barotropic compensation; these
% are zero if the controlling parameter p.C0 = 0.
