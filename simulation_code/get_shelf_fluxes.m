function [QVs0,QTs0,QSs0,Ss0,Ts0,phi0] = get_shelf_fluxes(i, p, f, s)
...
[Ts0, Ss0] = bin_ocean_profiles(f.Ts(:,i), f.Ss(:,i), f.zs, H0);
...
% depth mean = Qsg0
QVs0(1:s.ksill) = Q - H0(1:s.ksill)*(f.Qsg(i)+sum(Q))/sum(H0(1:s.ksill));
